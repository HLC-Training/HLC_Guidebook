...
function toggleContacts() {
    ...
    btn.textContent = isExpanded ? 'Ã¢ÂÂ¼ Show All Contacts (' + remaining + ' more)' : 'Ã¢ÂÂ² Hide Extended Contacts';
...
// ââ PLL Directory Renderer ââââââââââââââââââââââââââââââââââââââ
            ...
            if (data.siteRules) {
                ...
                if (contactsContainer && contacts.length) {
                    ...
                    var tableRows = contacts.map(function(c, i) {
                        ...
                        var phoneLink = c.phone ? '<a href="tel:' + c.phone.replace(/\s+/g,'') + '" rel="noopener noreferrer">' + c.phone + '</a>' : 'Ã¢ÂÂ';



                        var emailLink = c.email ? '<a href="mailto:' + c.email + '">' + c.email + '</a>' : 'Ã¢ÂÂ';
                        ...
                        return '<tr class="contact-row ' + hiddenClass + '"><td>' + c.role + '</td><td>' + (c.name || 'Ã¢ÂÂ') + '</td><td>' + phoneLink + '</td><td>' + emailLink + '</td></tr>';
                    ...
                    if (contacts.length > CONTACTS_DEFAULT_VISIBLE) {
                        ...
                        toggleDiv.innerHTML = '<button id="contacts-toggle-btn" class="contacts-toggle-btn" onclick="toggleContacts()" aria-expanded="false">Ã¢ÂÂ¼ Show All Contacts (' + remaining + ' more)</button>';
